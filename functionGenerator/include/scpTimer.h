...
/**
 * Class: scpTimer (CLS-013)
 * Responsibility: Manage timed operations in separate thread with countdown display
 * Association: Used by scpController (1:0..*) - "schedules operations with"
 */
class Timer {
public:
