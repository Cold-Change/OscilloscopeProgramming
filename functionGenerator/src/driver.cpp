...
void printUsage(const char *progName)
{
    ...
    std::cout << "  COLLECT_SAMPLES numberOfSamples=N    : Collect N samples" << std::endl;
    ...
    std::cout << "  " << progName << " START_SCOPE WAIT seconds=5 COLLECT_SAMPLES numberOfSamples=5000 WRITE_FILE filename=output.dat STOP_SCOPE" << std::endl;
    ...
    std::cout << "  COLLECT_SAMPLES numberOfSamples=10000" << std::endl;
